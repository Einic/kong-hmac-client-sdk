...
int main(int argc, char *argv[]) {
  std::string user = "<HMAC account>";
  std::string secret = "<HMAC secret>";
  std::string params = "{\"params\":{\"author\":\"EinicYeo\"}";
  ...
  std::string ret;
  postHttpRequest(&ret, "<Interface address with hmac authentication>", params, auth_info,
                  60, false);
